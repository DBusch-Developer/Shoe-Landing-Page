...
const Home: React.FC = () => {
  ...
  const handleLearnMoreProduct = (productName: string) => {
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              <Card
                ...
                secondaryAction={{
                  text: 'Learn More',
                  onClick: () => handleLearnMoreProduct('Air Comfort Pro')
                }}
              ...
              <Card
                ...
                secondaryAction={{
                  text: 'Learn More',
                  onClick: () => handleLearnMoreProduct('Trail Explorer')
                }}
              ...
              <Card
                ...
                secondaryAction={{
                  text: 'Learn More',
                  onClick: () => handleLearnMoreProduct('Urban Classic')
                }}
